      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <Card key={service.id} className="border-2 hover:shadow-lg transition-all bg-white/95 backdrop-blur-sm overflow-hidden relative animate-neon-glow" style={{ borderColor: '#fbbf24', boxShadow: '0 0 20px rgba(251, 191, 36, 0.5), inset 0 0 20px rgba(251, 191, 36, 0.1)' }}>
