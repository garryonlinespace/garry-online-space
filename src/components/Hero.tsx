        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-white animate-fade-in w-full max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center items-center">
              <Button asChild className="w-fit bg-white hover:bg-white/90 text-[#1e40af] font-bold text-sm sm:text-base px-5 sm:px-6 py-4 sm:py-5 rounded-full border-2 animate-neon-glow-blue animate-neon-border-pulse" style={{ borderColor: '#1e40af' }}>
